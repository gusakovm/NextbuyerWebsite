...
(function() {
    ...
    function attachHandlers() {
        ...
        links.forEach(function(link) {
            ...
            link.onclick = function(e) {
                ...
                console.log('[Nextbuyer] Contact us link clicked (onclick), scrolling to form');
                scrollToFirstForm();
                return false;
            };
            ...
            link.addEventListener('click', function(e) {
                ...
                e.stopPropagation();
                e.stopImmediatePropagation();
                console.log('[Nextbuyer] Contact us link clicked (listener), scrolling to form');
                scrollToFirstForm();
                return false;
            }, true);
        });
    ...
    function initContactButtons() {
        ...
        // Re-attach after Tilda might have initialized (multiple times)
